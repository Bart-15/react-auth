...
import {Box, Container, Button, Table, TableBody, TableContainer, TableHead, TableRow, Paper, Typography } from '@mui/material';
...
const Students = () => {
	...
	<Box component="div">
		...
		{(!students?.length && !isLoading) && (<Typography variant="subtitle1">No data.</Typography>)}
		</Container>
	</Box>  
	)
}
