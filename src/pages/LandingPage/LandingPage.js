				...
				/>
					...
					<Grid item xs={12} md={6}>
						<Box component="div" className={classes.textContainer}>
							...
							<Typography variant="subtitle1" className={classes.txt}>This is my simple implementation of JWT auth with refresh token using the MERN stack. The super admin can change the roles of each user update and delete the students (CRUD). You can use the super admin credentials to explore other features. Here are the credentials:
							</Typography>
